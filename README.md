...
* [2025] <ins>YeongHyeon Park</ins>, Myung Jin Kim, Hyeong Seok Kim. <strong>"Contrastive Language Prompting to Ease False Positives in Medical Anomaly Detection"</strong> IEEE ISBI _(Accepted)_ [<a href="https://arxiv.org/abs/2411.07546v2">arXiv</a>][<a href="https://github.com/YeongHyeon/Conference_History/raw/main/2025-ISBI_Park.pdf">poster</a>]  
* [2025] Myung Jin Kim <ins>YeongHyeon Park</ins>. <strong>"Encouraging LLM Thought Improvements for Medical Diagnosis Consistency"</strong> IEEE ISBI (1-Page Paper) _(Accepted)_
